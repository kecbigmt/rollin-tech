...
### Sec.4 タプルにxy座標を保存しよう
「タプル」というデータ構造のなかに、点のxy座標を保存しましょう。タプルとよく似たデータ構造に「リスト」というのもあるので、一緒に説明します。

※「データ構造」とは、データの保持の仕方のこと。例えば配列や行列など、データにはいろんな持ち方がある。ここで上げたものの他にも[辞書型（dict）](https://docs.python.jp/3/tutorial/datastructures.html#dictionaries)や[集合型（set）](https://docs.python.jp/3/tutorial/datastructures.html#sets)というデータ構造もありますが、ここでは扱いません。
